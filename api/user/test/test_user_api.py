...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_bad_credintials(self):
        """Test for token request with bad credintials"""
    ...
    def test_create_token_no_password(self):
        """Test for token creation with no password sends error"""
        create_user(email='test@example.com', password='goodpass')
    ...
    def test_retrieve_user_unauthorized(self):
        """Test that authentication is required to retrieve user"""
